...
internal static class ToolNavigationBuilder
{
    ...
    public static BuildResult Build(NavigationView nav, DrawerShellViewModel shellViewModel)
    {
        ...
        {
            // 首页、剪贴板历史、命令面板、文本工具、图片工具、系统工具、设置：渲染为单个顶级可点击项。
    ...
    private static bool ShouldRenderAsTopLevel(ToolCategory category)
        => category is ToolCategory.Home or ToolCategory.Clipboard or ToolCategory.Command or ToolCategory.Text or ToolCategory.Image or ToolCategory.System or ToolCategory.Settings;
}
